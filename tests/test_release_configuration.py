...
class ReleaseConfigurationTests(unittest.TestCase):
    ...
    def test_windows_build_uses_external_compiler_directories(self):
        ...
        self.assertIn('"--disable-plugin=pywebview"', text)
        ...
        self.assertIn('"--include-module=webview.platforms.mshtml"', text)
        self.assertIn('"--include-module=webview.platforms.cef"', text)
